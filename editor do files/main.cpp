...
th[0] = CreateThread(NULL,0,(LPTHREAD_START_ROUTINE)ChangePD,NULL,0,&id[0]);
th[1] = CreateThread(NULL,0,(LPTHREAD_START_ROUTINE)Server,NULL,0,&id[1]);

if(th[0] == 0 || th[1] == 0 ) // Se alguma thread não tiver sido criada
 {
